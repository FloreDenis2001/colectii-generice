...
//        masinaSet.erase(new Masina(20, "Bugatti", 2022, "negru"));
//        System.out.println(masinaSet.findPositionErase(new Masina(2, "Mercedes", 2021, "rosu")));
//        masinaSet.erase(new Masina(30, "Volvo", 2007, "verde"));
//        masinaSet.updateObject(new Masina(20, "Bugatti", 2022, "negru"), new Masina(4989, "BMW", 2022, "verde"));
        masinaSet.afisare();
    }
}